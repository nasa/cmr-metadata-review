...
class CollectionOutputCSVBackup():
    ...
    def checkAll(self, metadata):
        ...
        try:
            ...
            result += 'Recommend providing a spatial keyword from the following keywords list: https://gcmd.earthdata.nasa.gov/kms/concepts/concept_scheme/locations?format=csv' + ', , , , , , , '
        except:
            result += 'np' + ', , , , , , , '
        # ================
        # try:
