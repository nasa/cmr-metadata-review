...
//AB hacked this in to move the source toggle up
function hookSourceViews() {
  $('.method-heading').click( function(e) {
    var descrip = this.parentElement.getElementsByClassName("method-description")[0];
    var source = descrip.getElementsByClassName("method-source-code")[0];

    descrip.insertBefore(source, descrip.firstChild);
    // var source = this.getElementsByClassName("method-source-code")[0];
    // this.insertBefore(source, this.firstChild);
    showSource(e);
  });
};
