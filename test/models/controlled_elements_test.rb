...
class ControlledElementsTest < ActiveSupport::TestCase
  ...
  # context "controlled elements tests" do
    test "can return proper description given specified field for umm_json" do
    ...
    test "can return proper description given specified field for dif10" do
      controlled_elements = ControlledElements.instance
    ...
    test "can return proper description given specified field for echo10" do
      controlled_elements = ControlledElements.instance
    ...
    test "can return proper description given specified field for umm-g json" do
      controlled_elements = ControlledElements.instance
