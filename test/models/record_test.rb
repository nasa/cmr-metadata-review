...
class RecordTest < ActiveSupport::TestCase
  ...
  describe "evaluate_script" do
    ...
    it "returns results of the automated collection_script for dif10" do
      ...
      expect_str="{\"Access_Constraints\"=>\"<b>Errors:</b><ul><li>Error: Character content other than whitespace is not allowed because the content type is 'element-only'.</li> </ul>schema failed<br>\", \"Dataset_Citation/Dataset_Release_Date\"=>\"OK\", \"Dataset_Citation/Dataset_Title\"=>\"OK\", \"Dataset_Citation/Online_Resource\"=>\"OK\", \"Dataset_Citation/Persistent_Identifier/Explanation\"=>\"OK\", \"Dataset_Citation/Persistent_Identifier/Identifier\"=>\"<b>Errors:</b><ul><li>Error: `doi:10.4225/15/5747A30D1F767` is invalid.</li> </ul><b>Remediation:</b><br>Provide a valid DOI. Make sure the field contains only the DOI string (eg. 10.1109/5.771073), not the URL.\", \"Dataset_Citation/Version\"=>\"OK\", \"Dataset_Progress\"=>\"OK\", \"Entry_Title\"=>\"OK\", \"IDN_Node/Short_Name\"=>\"OK\", \"ISO_Topic_Category\"=>\"OK\", \"Location/Location_Category\"=>\"OK\", \"Location/Location_Type\"=>\"OK\", \"Metadata_Dates/Data_Creation\"=>\"OK\", \"Metadata_Dates/Data_Last_Revision\"=>\"OK\", \"Metadata_Dates/Metadata_Creation\"=>\"OK\", \"Metadata_Dates/Metadata_Last_Revision\"=>\"OK\", \"Multimedia_Sample/Description\"=>\"OK\", \"Organization/Organization_Name/Long_Name\"=>\"OK\", \"Organization/Organization_Name/Short_Name\"=>\"OK\", \"Organization/Organization_URL\"=>\"<b>Errors:</b><ul><li>Error: Invalid URL/s: `[{'url': 'http://data.aad.gov.au', 'error': \\\"The URL is secure. Please use 'https' instead of 'http'.\\\"}]`.</li> </ul><b>Remediation:</b><br>Please provide valid URL/s.\", \"Organization/Personnel/Contact_Person/First_Name\"=>\"OK\", \"Personnel/Contact_Person/First_Name\"=>\"OK\", \"Platform/Characteristics/DataType\"=>\"OK\", \"Platform/Characteristics/Description\"=>\"OK\", \"Platform/Characteristics/Name\"=>\"OK\", \"Platform/Characteristics/Unit\"=>\"OK\", \"Platform/Characteristics/Value\"=>\"OK\", \"Platform/Instrument/Characteristics/DataType\"=>\"OK\", \"Platform/Instrument/Characteristics/Description\"=>\"OK\", \"Platform/Instrument/Characteristics/Name\"=>\"OK\", \"Platform/Instrument/Characteristics/Unit\"=>\"OK\", \"Platform/Instrument/Characteristics/Value\"=>\"OK\", \"Platform/Instrument/Long_Name\"=>\"<b>Errors:</b><ul><li>Warning: The instrument long name is missing.</li> <li>Warning: The instrument long name is missing.</li> <li>Warning: The instrument long name is missing.</li> </ul><b>Remediation:</b><br>Please add the associated instrument long name.\", \"Platform/Instrument/Sensor/Characteristics/DataType\"=>\"OK\", \"Platform/Instrument/Sensor/Characteristics/Description\"=>\"OK\", \"Platform/Instrument/Sensor/Characteristics/Name\"=>\"OK\", \"Platform/Instrument/Sensor/Characteristics/Unit\"=>\"OK\", \"Platform/Instrument/Sensor/Characteristics/Value\"=>\"OK\", \"Platform/Instrument/Short_Name\"=>\"<b>Errors:</b><ul><li>Error: The provided instrument short name `Not provided` does not comply with the GCMD.</li> <li>Error: The provided instrument short name `Not provided` does not comply with the GCMD.</li> </ul><b>Remediation:</b><br>Please submit a request to support@earthdata.nasa.gov to have this instrument added to the GCMD Instrument KMS.\", \"Platform/Long_Name\"=>\"<b>Errors:</b><ul><li>Warning: The platform long name is not provided.</li> <li>Warning: The platform long name is not provided.</li> <li>Warning: The platform long name is not provided.</li> </ul><b>Remediation:</b><br>Recommend providing the platform long name.\", \"Platform/Short_Name\"=>\"<b>Errors:</b><ul><li>Error: The provided platform short name `Not provided` does not comply with the GCMD.</li> </ul><b>Remediation:</b><br>Please submit a request to support@earthdata.nasa.gov to have this platform added to the GCMD platform KMS.\", \"Platform/Type\"=>\"<b>Errors:</b><ul><li>Error: The provided platform type `Not provided` does not comply with the GCMD.</li> <li>Error: The provided platform type `Not provided` does not comply with the GCMD.</li> <li>Error: The provided platform type `Not provided` does not comply with the GCMD.</li> </ul><b>Remediation:</b><br>Please submit a request to support@earthdata.nasa.gov to have this platform type added to the GCMD Platforms KMS.\", \"Project/Long_Name\"=>\"<b>Errors:</b><ul><li>Warning: The project long name is missing.</li> </ul><b>Remediation:</b><br>Please add the associated project long name\", \"Project/Short_Name\"=>\"<b>Errors:</b><ul><li>Error: The provided campaign short name `Not provided` does not comply with the GCMD.</li> </ul><b>Remediation:</b><br>Please submit a request to support@earthdata.nasa.gov to have this campaign short name added to the GCMD Projects KMS.\", \"Reference/Persistent_Identifier/Identifier\"=>\"<b>Errors:</b><ul><li>Error: `doi:10.1016/j.chemosphere.2004.05.042` is invalid.</li> </ul><b>Remediation:</b><br>Provide a valid DOI. Make sure the field contains only the DOI string (eg. 10.1109/5.771073), not the URL.\", \"Related_URL\"=>\"OK\", \"Related_URL/Description\"=>\"OK\", \"Related_URL/Mime_Type\"=>\"OK\", \"Related_URL/URL\"=>\"<b>Errors:</b><ul><li>Error: Invalid URL/s: `[{'url': 'http://data.aad.gov.au/aadc/portal/download_file.cfm?file_id=1677', 'error': \\\"The URL is secure. Please use 'https' instead of 'http'.\\\"}]`.</li> <li>Error: Invalid URL/s: `[{'url': 'http://data.aad.gov.au/aadc/metadata/citation.cfm?entry_id=ASAC_2201_HCL_0.5', 'error': \\\"The URL is secure. Please use 'https' instead of 'http'.\\\"}]`.</li> </ul><b>Remediation:</b><br>Please provide valid URL/s.\", \"Science_Keywords/Category\"=>\"OK\", \"Spatial_Coverage/Geometry/Bounding_Rectangle\"=>\"OK\", \"Spatial_Coverage/Geometry/Bounding_Rectangle/Westernmost_Longitude\"=>\"<b>Errors:</b><ul><li>Error: North bounding coordinate should always be larger than South bounding coordinate and East bounding coordinate should always be larger than West bounding coordinate.</li> </ul><b>Remediation:</b><br>Please make sure the coordinate values are correct.\", \"Spatial_Coverage/Geometry/Coordinate_System\"=>\"OK\", \"Spatial_Coverage/Granule_Spatial_Representation\"=>\"OK\", \"Spatial_Coverage/Spatial_Coverage_Type\"=>\"<b>Errors:</b><ul><li>Error: The Spatial Coverage Type provided `['Horizontal']` is invalid.</li> </ul><b>Remediation:</b><br>Please provide a Spatial Coverage Type from the following list: ['HORIZONTAL', 'VERTICAL', 'ORBITAL', 'HORIZONTAL_VERTICAL', ORBITAL_VERTICAL', 'HORIZONTAL_ORBITAL', 'HORIZONTAL_VERTICAL_ORBITAL']\", \"Spatial_Coverage/Spatial_Info/Horizontal_Coordinate_System/Geodetic_Model/Horizontal_DatumName\"=>\"<b>Errors:</b><ul><li>Info: Horizontal Datum Name is missing.</li> </ul><b>Remediation:</b><br>Please provide a Horizontal Datum Name.\", \"Summary/Abstract\"=>\"OK\", \"Temporal_Coverage/Ends_At_Present_Flag\"=>\"OK\", \"Temporal_Coverage/Range_DateTime/Beginning_Date_Time\"=>\"OK\", \"Temporal_Coverage/Range_DateTime/Ending_Date_Time\"=>\"OK\", \"Temporal_Coverage/Single_DateTime\"=>\"OK\", \"Use_Constraints/License_URL/Description\"=>\"OK\", \"Use_Constraints/License_URL/URL\"=>\"<b>Errors:</b><ul><li>Warning: No license information is provided.</li> </ul><b>Remediation:</b><br>Please provide information about the license applicable to the dataset, preferably as a URL. For EOSDIS records, please providing the following link (unless under different usage terms): https://earthdata.nasa.gov/earth-observation-data/data-use-policy\"}"
