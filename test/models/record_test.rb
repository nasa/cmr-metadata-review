...
class RecordTest < ActiveSupport::TestCase
  ...
  describe "evaluate_script" do
    ...
    it "returns results of the automated collection_script" do
      ...
      expect_str=%q{{"AdditionalAttributes/AdditionalAttribute/DataType"=>"OK", "AdditionalAttributes/AdditionalAttribute/Value"=>"OK", "ArchiveCenter"=>"<b>Errors:</b><ul><li>Error: The provided data center short name `GHRC` does not comply with the GCMD. </li> </ul><b>Remediation:</b><br>Please submit a request to support@earthdata.nasa.gov to have this instrument added to the GCMD Instrument KMS.", "Campaigns/Campaign/ShortName"=>"OK", "CollectionDataType"=>"OK", "Contacts/Contact/Role"=>"<b>Errors:</b><ul><li>Error: `GHRC USER SERVICES` is not a valid Contact Role.</li> </ul><b>Remediation:</b><br>Select a Contact Role from the following list: ['ARCHIVER', 'DISTRIBUTOR', 'PROCESSOR', 'ORIGINATOR'].", "DataSetId"=>"OK", "Description"=>"OK", "InsertTime"=>"OK", "LastUpdate"=>"OK", "OnlineResources/OnlineResource/MimeType"=>"OK", "OnlineResources/OnlineResource/URL"=>"<b>Errors:</b><ul><li>Error: Invalid URL/s: `https://lance.nsstc.nasa.gov/amsr2-science/browse_png/level3/daysnow/R00/`.</li> <li>Error: Invalid URL/s: `http://lance.nsstc.nasa.gov/amsr2-science/doc/LANCE_A2_DySno_NRT_dataset.pdf`.</li> </ul><b>Remediation:</b><br>Please provide valid URL/s.", "Platforms/Platform/Instruments/Instrument/Characteristics/Characteristic/Description"=>"OK", "Platforms/Platform/Instruments/Instrument/Characteristics/Characteristic/Name"=>"OK", "Platforms/Platform/Instruments/Instrument/Characteristics/Characteristic/Unit"=>"OK", "Platforms/Platform/Instruments/Instrument/Characteristics/Characteristic/Value"=>"OK", "Platforms/Platform/Instruments/Instrument/Sensors/Sensor/ShortName"=>"OK", "Platforms/Platform/Instruments/Instrument/ShortName"=>"OK", "Platforms/Platform/LongName"=>"<b>Errors:</b><ul><li>Error: The provided platform long name `GCOM-W1` does not comply with the GCMD.</li> </ul><b>Remediation:</b><br>Please submit a request to support@earthdata.nasa.gov to have this data format added to the GCMD Data Format KMS.", "Platforms/Platform/ShortName"=>"OK", "Platforms/Platform/Type"=>"<b>Errors:</b><ul><li>Error: The provided platform type `SATELLITE` does not comply with the GCMD.</li> </ul><b>Remediation:</b><br>Please submit a request to support@earthdata.nasa.gov to have this platform type added to the GCMD Locations KMS.", "ProcessingLevelId"=>"OK", "ScienceKeywords/ScienceKeyword/CategoryKeyword"=>"OK", "Spatial/GranuleSpatialRepresentation"=>"OK", "Spatial/HorizontalSpatialDomain/Geometry/BoundingRectangle"=>"<b>Errors:</b><ul><li>Error: North bounding coordinate should always be larger than South bounding coordinate and East bounding coordinate should always be larger than West bounding coordinate.</li> </ul><b>Remediation:</b><br>Please make sure the coordinate values are correct.", "Spatial/HorizontalSpatialDomain/Geometry/CoordinateSystem"=>"<b>Errors:</b><ul><li>Error: Missing child element(s). Expected is one of ( Point, BoundingRectangle, GPolygon, Line ).</li> </ul>xml_schema failed<br>", "Spatial/SpatialCoverageType"=>"OK", "SpatialKeywords/Keyword"=>"OK", "Temporal/EndsAtPresentFlag"=>"<b>Errors:</b><ul><li>Warning: Potential issue with:\n - No EndingDateTime provided; no EndsAtPresentFlag provided for a potentially active collection. \n - CollectionState = ACTIVE; no EndsAtPresentFlag provided for a potentially active collection.</li> </ul><b>Remediation:</b><br>If data collection is ongoing, provide an EndsAtPresentFlag of \"true\"", "Temporal/RangeDateTime/BeginningDateTime"=>"OK"}}
