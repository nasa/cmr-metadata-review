...
describe "POST #create" do
    it "downloads and saves a new record" do
      ...
      stub_request(:get, "#{@cmr_base_url}/search/granules.umm_json?collection_concept_id=C222702-GHRC&page_num=3&page_size=10").
        with(
          headers: {
            'Accept'=>'*/*',
            'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
      ...
      stub_request(:get, "#{@cmr_base_url}/search/granules.umm_json?collection_concept_id=C222702-GHRC&page_num=2&page_size=10").
        with(
          headers: {
            'Accept'=>'*/*',
            'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
        ...
        to_return(status: 200, body: get_stub("search_granules_G309203-GHRC.json"), headers: {})
      stub_request(:get, "#{@cmr_base_url}/search/granules.umm_json?collection_concept_id=C222702-GHRC&page_num=1&page_size=10").
        with(
          headers: {
            'Accept'=>'*/*',
            'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
